...
if {[file isfile simple_combinational_circuit.autotvin.dat]} {
	file delete -force simple_combinational_circuit.autotvin.dat
}

if {[file isfile simple_combinational_circuit.autotvout.dat]} {
	file delete -force simple_combinational_circuit.autotvout.dat
}
