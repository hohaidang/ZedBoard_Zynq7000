...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.simple_combinational_circuit.autotvin_a.dat"
         "c.simple_combinational_circuit.autotvin_b.dat"
         "c.simple_combinational_circuit.autotvin_c.dat"
         "c.simple_combinational_circuit.autotvout_d.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.simple_combinational_circuit.autotvout_d.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
