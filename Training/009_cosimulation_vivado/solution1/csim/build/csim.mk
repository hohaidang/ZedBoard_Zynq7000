...
HLS_SOURCES = ../../../test-tb.cpp ../../../top.cpp
...
$(ObjDir)/test-tb.o: ../../../test-tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../test-tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/test-tb.d
