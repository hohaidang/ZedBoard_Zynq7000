...
$(ObjDir)/simple_combination_circuit-tb.cpp_pre.cpp.tb.o : simple_combination_circuit-tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling simple_combination_circuit-tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/simple_combination_circuit.cpp_pre.cpp.tb.o : simple_combination_circuit.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling simple_combination_circuit.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
