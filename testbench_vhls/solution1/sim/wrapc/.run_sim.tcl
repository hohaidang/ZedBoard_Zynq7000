...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "simple_combinational_circuit.autotvin.dat"
	set constFileTvOut       "simple_combinational_circuit.autotvout.dat"
	set constFileHdlTvIn     "simple_combinational_circuit.autohdltvin.dat"
	set constFileHdlTvOut    "simple_combinational_circuit.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
