# 1 "sw_control_led_vhls/sw_control_led.cpp"
# 1 "sw_control_led_vhls/sw_control_led.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 152 "<built-in>" 3
# 1 "<command line>" 1
...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "sw_control_led_vhls/sw_control_led.cpp" 2
void sw_control_led(unsigned char inputs, unsigned char &outputs) {
_ssdm_op_SpecInterface(outputs, "ap_none", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(inputs, "ap_none", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
