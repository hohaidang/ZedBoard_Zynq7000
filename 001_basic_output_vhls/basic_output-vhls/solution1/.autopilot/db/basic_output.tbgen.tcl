...
set C_modelName {basic_output}
set C_modelType { void 0 }
set C_modelArgList {
	{ o int 8 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "o", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "o","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} ]}
