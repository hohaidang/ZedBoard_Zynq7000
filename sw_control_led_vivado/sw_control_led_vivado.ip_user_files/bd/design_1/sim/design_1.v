...
module design_1
  ...
  wire [7:0]inputs_0_1;
  wire [7:0]sw_control_led_0_outputs;

  assign inputs_0_1 = sw[7:0];
  assign led[7:0] = sw_control_led_0_outputs;
  design_1_sw_control_led_0_0 sw_control_led_0
       (.inputs(inputs_0_1),
        .outputs(sw_control_led_0_outputs));
endmodule
